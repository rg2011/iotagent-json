...
function parserBody() {
    ...
    return function (req, res, next) {
        // Don't use `req.is`, because it might fail to recognize valid
        // content-types (see issue).
        // Instead, trim the Content-Type header to extract only the
        // media type part, which is the only thing we need to check.
