...
function parserBody() {
    ...
    const xmlParser = bodyParser.xml({
        // The "type" option should return true if the body must be parsed.
        // The default behaviour is to check against content-types 'xml0, '+xml'.
        // Since we check content-types ourselves, we override this behaviour
...
// Checks content-type header, before body is processed.
