...
function parserBody() {
    ...
    return function (req, res, next) {
        ...
        config.getLogger().info(context, "received content type '%', matched to '%s'", content_type, matched_type)
    };
}
...
function checkMandatoryParams(queryPayload) {
    return function (req, res, next) {
        ...
        if (
            ...
            config.getLogger().info(context, 'Unidentified content type: %s, body: %s', JSON.stringify(req.headers), req.body);
